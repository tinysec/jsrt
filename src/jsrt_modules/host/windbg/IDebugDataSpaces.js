...
function ReadMsr( arg_index )
{
	...
	return Number64( process.reserved.hostDependBindings.IDebugDataSpaces_ReadMsr( arg_index ) );
}
...
function WriteMsr( arg_index , arg_value )
{
	...
	return process.reserved.hostDependBindings.IDebugDataSpaces_WriteMsr( arg_index , Number64(arg_value) );
}
...
function ReadPhysical( arg_address , arg_buffer , arg_readBytes )
{
	...
	return process.reserved.hostDependBindings.IDebugDataSpaces_ReadPhysical( Number64(arg_address) , arg_buffer , arg_readBytes || arg_buffer.length ) ;
}
...
function ReadVirtual( arg_address , arg_buffer , arg_readBytes )
{
	...
	return process.reserved.hostDependBindings.IDebugDataSpaces_ReadVirtual( Number64(arg_address) , arg_buffer , arg_readBytes || arg_buffer.length ) ;
}
...
function ReadVirtualUncached( arg_address , arg_buffer , arg_readBytes )
{
	...
	return process.reserved.hostDependBindings.IDebugDataSpaces_ReadVirtualUncached( Number64(arg_address) , arg_buffer , arg_readBytes || arg_buffer.length ) ;
}
...
function WritePhysical( arg_address , arg_buffer , arg_writeBytes )
{
	...
	return process.reserved.hostDependBindings.IDebugDataSpaces_WritePhysical( Number64(arg_address) , arg_buffer , arg_writeBytes || arg_buffer.length ) ;
}
...
function WriteVirtual( arg_address , arg_buffer , arg_writeBytes )
{
	...
	return process.reserved.hostDependBindings.IDebugDataSpaces_WriteVirtual( Number64(arg_address) , arg_buffer , arg_writeBytes || arg_buffer.length  ) ;
}
...
function WriteVirtualUncached( arg_address , arg_buffer , arg_writeBytes )
{
	...
	return process.reserved.hostDependBindings.IDebugDataSpaces_WriteVirtualUncached( Number64(arg_address) , arg_buffer ,  arg_writeBytes || arg_buffer.length  ) ;
}
...
function SearchVirtual( arg_address , arg_length , arg_pattern , arg_granularity )
{
	...
	return process.reserved.hostDependBindings.IDebugDataSpaces_SearchVirtual( 
